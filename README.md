...
```
GET /api/envios, POST /api/envios, GET /api/envios/{id}, GET /api/envios/pedido/{pid}, PUT /api/envios/{id}/estado
```
...
| Remoto (Render) | https://ms-envios-swls.onrender.com/swagger-ui.html |
...
```
https://ms-gateway-ndke.onrender.com/api/envios
```
...
Desplegado en **Render**: https://ms-envios-swls.onrender.com
